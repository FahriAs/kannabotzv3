...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'edukasi', 'news', 'random', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'store', 'downloader', 'tools', 'fun', 'database','quran', 'apkmod', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']

...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'edukasi', 'news', 'random', 'game', 'xp', 'islamic', 'stiker', 'convert', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'store', 'downloader', 'tools', 'fun', 'database','quran', 'apkmod', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
   ...
   const sections = [
   {
    ...
    {title: `🛒 ${pmenus} Menu Store`, rowId: ".? store", description: "Fitur Khusus Di Group"},
    {title: `🔧 ${pmenus} Mods Apk`, rowId: ".? apkmod", description: "Menampilkan Menu Mods Apk..."},
